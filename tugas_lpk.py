...
#KONTEN UNTUK MATERI TITRIMETRI
    if pilihan1 == 'Pilih Materi Praktik Titrimetri':
        ...
        if pilihan2 == 'Pilih Data Pengamatan':
             st.title('')
                ...
                data_table=[
                {'Indikator': 'MM', 'Perubahan Warna': 'Merah muda menjadi kuning '}, 
                {'Indikator': 'BTB', 'Perubahan Warna':'Kuning menjadi biru seulas (dengan warna antra hijau'}, 
                {'Indikator': 'PP', 'Perubahan Warna': 'Larutan tidak berwarna menjadi merah muda seulas'},
                {'Indikator': 'SM', 'Perubahan Warna': 'Mera menjadi Kuning (dengan warna antara jingga)'}
                ]
                st.table(data_table)
              ...
              #MEMBUAT TABEL DENGAN st.table()
                ...
                {'Indikator': 'SM', 'Perubahan Warna': 'Merah menjadi kuning (dengan warna antara jingga)'}
                ]
                st.table(data_table)
              ...
              #MEMBUAT TABEL DENGAN st.table()
                ...
                {'Indikator': 'PP', 'Perubahan Warna': 'Merah muda menjadi tidak berwarna'},
                {'Indikator': 'SM', 'Perubahan Warna': 'Merah seulas menjadi tidak berwarna'}
                ]
                st.table(data_table)
        ...
        elif pilihan2 == '4. Titrasi Basa Lemah oleh Asam Kuat':
            def main():
    ...
    elif pilihan1 == 'Percobaan 4. Standardisasi Larutan Tiosulfat':
...
with Perhitungan_Titrimetri:
    ...
    if pilihan3 == 'Pilih Opsi':
        ...
        if st.button('Hitung'):
            st.success(f'{Normalitas} mgrek/mL')
    ...
    elif pilihan3 == 'Konversi %b/b menjadi %b/v':
        ...
        if st.button ('Hitung'):
            st.success(f'{Berat_Pervolum}%b/v')
...
with Materi_Praktik_kimia_Organik:
    ...
    if pilihan4 == 'Pilih Materi Praktik Kimia Organik':
        ...
        elif pilihan5 == 'Percobaan 5. Uji Fisika dan Kimia Benzena':
    ...
    elif pilihan4 == 'Percobaan 2. Alkohol dan Fenol':
        ...
        elif pilihan6 == 'Percobaan 7. Uji kelarutan dan Keasaman Fenol':
